...
function recalculer() {
    ...
    // 1. COLLECT QUANTITIES FOR DEGRESSIVITY
    document.querySelectorAll('.bloc').forEach(bloc => {
        bloc.querySelectorAll('tbody tr').forEach(tr => {
            ...
            // Special handling for A5/A6 printing to base price on A4 volume/key
    ...
    document.querySelectorAll('.bloc').forEach(bloc => {
        ...
        bloc.querySelectorAll('tbody tr').forEach(tr => {
            ...
            if(paliers) {
               ...
               // Find the correct tier (by iterating reversed, to find the highest matching 'min')
            ...
            // Reverse the A5/A6 pricing adjustment for the unit price displayed
            ...
            // Line Total (with minimum charge applied if applicable)
